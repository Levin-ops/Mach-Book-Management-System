...
def seed_data():
    ...
    book4 = Book(book_title="To Kill a Mockingbird", book_genre="Drama", book_status="New", author=author4)
    book5 = Book(book_title="1984", book_genre="Dystopian", book_status="New", author=author5)
    book6 = Book(book_title="War and Peace", book_genre="Historical Fiction", book_status="New", author=author6)
    book7 = Book(book_title="Adventures of Huckleberry Finn", book_genre="Adventure", book_status="New", author=author7)
    book8 = Book(book_title="The Great Gatsby", book_genre="Classic", book_status="New", author=author8)
    book9 = Book(book_title="Great Expectations", book_genre="Classic", book_status="New", author=author9)
    book10 = Book(book_title="The Old Man and the Sea", book_genre="Literary Fiction", book_status="New", author=author10)
